...
public class TestStudent {
	...
	public static void main(String[] args) {
		...
		try (Scanner sc = new Scanner(System.in)) {
			...
			s[0] = new Student("dac-001", "Student One", null, null, null, null);
			limit--;
			s[1] = new Student("dac-002", "Student Two", null, null, null, null);
			limit--;
			s[2] = new Student("dac-003", "Student Three", null, null, null, null);
			limit--;
			...
			Course course = validateCourse(courseString);
			...
			tempStudent = new Student(prn, name, email, null, date, course);
