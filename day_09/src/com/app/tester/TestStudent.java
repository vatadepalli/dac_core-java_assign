		...
		try (Scanner sc = new Scanner(System.in)) {
			...
			while (!exit) {
				try {
					...
					System.out.println("1.Add New Student\n" + "2.Display Student Details of a course\n"
					...
					switch (sc.nextInt()) {
					case 1:
						System.out.println("Enter Student Details (PRN, Name, Email, Marks, Course("
								+ Arrays.toString(Course.values()) + "), DOB)");
						students.add(new Student(checkPRN(new Student(sc.next()), students), validateName(sc.next()),
								validateEmail(sc.next()), validateMarks(sc.nextInt()), validateCourse(sc.next()),
								validateDate(sc.next())));
						System.out.println("Student Enrolled Successfully!");
						break;
					case 2:
						System.out.println("Enter course name : ");
						Course stc = validateCourse(sc.next());
					...
					case 3:
						...
						int index = students.indexOf(new Student(sc.next()));
						if (index == -1)
						...
						System.out.println("Marks of Student " + students.get(index).getName() + " (whose marks were= "
								+ prevMarks + ") has been Updated to " + students.get(index).getMarks());
						break;
					case 4:
					...
					case 8:
						System.out.println("Enter Course Name: ");
						Course stcs = validateCourse(sc.next());
