...
import static com.app.utils.SIOUtils.*;
			...
			while (!exit) {
				try {
					...
					case 1:
						...
						BankAccount a = new BankAccount(checkForDupAccNo(sc.next(), accts), sc.next(),
								validateBalance(sc.nextDouble()), parseNValidateDate(sc.next()),
					...
					case 8: // sort bank accounts as per asc acct id
						...
						TreeMap<String, BankAccount> tm = new TreeMap<String, BankAccount>(accts);
					...
					case 9: // sort bank accounts as per desc acct id
						...
						TreeMap<String, BankAccount> tm2 = new TreeMap<String, BankAccount>(new Comparator<String>() {
